...
public:
  ...
  static constexpr KDSize charSize(FontSize size = FontSize::Large) {
    return size == FontSize::Large ?
      KDSize(BITMAP_LargeFont_CHARACTER_WIDTH, BITMAP_LargeFont_CHARACTER_HEIGHT) :
      KDSize(BITMAP_SmallFont_CHARACTER_WIDTH, BITMAP_SmallFont_CHARACTER_HEIGHT);
  }
};
